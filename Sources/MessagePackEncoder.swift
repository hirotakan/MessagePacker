...
extension MessagePackEncoder {
    class KeyedContainer<Key: CodingKey>: KeyedEncodingContainerProtocol {
        ...
        fileprivate func set(_ value: Data, forKey key: CodingKey) {
        ...
        func encodeNil(forKey key: Key) throws {
            set(encoder.boxNil(), forKey: key)
        }

        func encode(_ value: Bool, forKey key: Key) throws {
            set(encoder.boxMessagePack(value), forKey: key)
        }

        func encode(_ value: Int, forKey key: Key) throws {
            set(encoder.boxInteger(value), forKey: key)
        }
    ...
    class MessagePackReferencingKeyedEncoder<Key: CodingKey>: MessagePackEncoder {
        ...
        deinit {
            container.set(storage.popContainer(), forKey: key)
        }
    }
